...
import com.margo.iPopUp.service.util.FastDFSUtil;
import com.margo.iPopUp.service.util.ImageUtil;
import com.margo.iPopUp.service.util.IpUtil;
...
public class VideoService {
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        com.margo.iPopUp.domain.File file = fileService.getFileByMd5(fileMd5);
